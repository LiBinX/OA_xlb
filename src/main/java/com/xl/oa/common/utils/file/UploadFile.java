package com.xl.oa.common.utils.file;

import com.xl.oa.common.utils.DateUtils;
import com.xl.oa.common.utils.ftp.FtpUtil;
...
public class UploadFile{
    ...
    public static final String basepath = "D:/Application/Professional Application/Data/OA_xlb/src/main/resources/static/img/";
    public static final String basepath1 = "/img/";
    /**
     * 默认大小 10M //字节
     */
    ...
    public static String upload(MultipartFile file) throws IOException, FileSizeException, FileNameLengthException
    {
        ...
        File desc = getAbsoluteFile(basepath, name);
